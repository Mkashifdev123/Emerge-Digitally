...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.iframe-wrapper').forEach(wrapper => {
   ...
   const thumbnail_id = wrapper.dataset.thumbId || '';
    console.log(thumbnail_id)
    const image_url =  wrapper.dataset.thumbUrl || (thumbnail_id ? `https://drive.google.com/thumbnail?id=${thumbnail_id}&sz=w340-h600` : '');
    const thumbUrl = image_url || `https://drive.google.com/thumbnail?id=${id}&sz=w340-h600`;
